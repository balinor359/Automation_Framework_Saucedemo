...
public class CheckoutSuccessPage extends TestUtilities {
    ...
    private static final String BACK_HOME_BUTTON_TEXT = "Back Home";
    private static final String BACK_HOME_BUTTON_FONT_COLOR = "#132322";
    private static final String BACK_HOME_BUTTON_BACKGROUND_COLOR = "#3ddc91";
    ...
    public void backHomeButtonValidator() {
        ...
        Assert.assertEquals(fontColorHex, BACK_HOME_BUTTON_FONT_COLOR, DIFFERENT_CSS_VALUE);
